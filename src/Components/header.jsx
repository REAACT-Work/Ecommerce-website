                ...
                <div className="row align-item-center ">
                    ...
                    <div className='col-6 d-flex justify-content-between'>
                        ...
                        <div>
                            ...
                            <Link><AiOutlineMail className='fs-6 mx-4' /></Link>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <header className='header-upper sticky-top'>
            <div className='container-fluid'>
                <div className='row'>
                    ...
                    <div className="col-4 d-flex align-items-center justify-content-between mx-auto ">
                        ...
                        <div className='nav-link-nav col-3 d-flex px-5 align-items-center justify-content-between '>
                        <Link to={'wishlist'} className='d-flex fs-5 px-2 pt-3'><HiOutlineInboxIn/>
                        <p className={location.pathname==="/wishlist" ? 'aactive' : 'iinactive'}>Wishlist</p>
                        </Link>
                        <Link to={'account'} className='d-flex fs-5   px-2 pt-3'><VscAccount/>
                        <p className={location.pathname==="/account" ? 'aactive' : 'iinactive'}>Account</p>
                        </Link>
                        <Link to={'cart'} className='d-flex fs-5 px-2 pt-3'><CgShoppingCart/>
