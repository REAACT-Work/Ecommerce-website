...
export const PRODUCTS = [
    {
        ...
        id: 6,
        image: pr7,
        name: "Men's Cotton Classic Short ",
        price: 39.50,
        brand: 'Puma',
        status:'in stock',
        rate: '50% Off'
...
export const  PRODUCTS1 = [
    {
        ...
        id: 17,
        image: img2,
        name: "Men's Dri-FIT T-Shirt Dri-FIT T-Shirt",
        price: 24.90,
        brand: 'Nike',
        status: 'in stock',
        rate: '60% off'
        ...
        id: 18,
        image: img3,
        name: "Women's Badge of Sport Tee Dri-FIT T-Shirt",
        price: 39.90,
        brand: 'Adidas',
        status: 'in stock',
        rate: '60% off'
